...
class SelectSol extends PureComponent {
    ...
    changePropsSol(value) {
        const {minSol, maxSol, changeSol} = this.props;
        changeSol({current: value, min: minSol, max: maxSol});
    }
...
export default connect(null, {changeSol})(withStyles(styles)(SelectSol));
